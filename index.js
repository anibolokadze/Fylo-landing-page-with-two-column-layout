...
function validateEmail(){
    if(!emailField.value.match(/^(([^<>()[\]\\.,;:\s@"]+(\.[^<>()[\]\\.,;:\s@"]+)*)|(".+"))@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\])|(([a-zA-Z\-0-9]+\.)+[a-zA-Z]{2,}))$/)){
        ...
        emailError.style.color = "red"; //error msg color
        emailField.style.color='black'; //make input text black
        return false;
    }
...
function validateEmail2(){
    if(!emailField2.value.match(/^(([^<>()[\]\\.,;:\s@"]+(\.[^<>()[\]\\.,;:\s@"]+)*)|(".+"))@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\])|(([a-zA-Z\-0-9]+\.)+[a-zA-Z]{2,}))$/)){
        ...
        emailError2.style.color = "white"; //error msg color
        emailField2.style.color='black'; //make input text black
        return false;
    }
